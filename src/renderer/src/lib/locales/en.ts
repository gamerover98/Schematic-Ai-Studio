...
export const en = {
  ...
  // placed. The link text is its own key so the sentences around it can be
  // reworded without touching it.
  "banner.hint.editor": "Planet Minecraft banner editor",
  "banner.hint.place.before":
    "Banner patterns: place the banner and click it. The inspector builds the design layer by layer, or takes the /give command generated by the ",
  "banner.hint.place.after": ".",
  "banner.hint.inspector.before": "Design one on the ",
  "banner.hint.inspector.after": " and paste the /give command it generates below.",

  "banner.editor.title": "Banner patterns",
  "banner.editor.empty": "No patterns: the banner is its plain colour.",
  "banner.editor.order": "Layer 1 is painted first; each one after it goes on top.",
  "banner.editor.pattern": "Pattern of layer {n}",
  "banner.editor.color": "Colour of layer {n}",
  "banner.editor.pickColor": "Choose a colour for layer {n}",
  "banner.editor.moveUp": "Move layer {n} down the stack (painted earlier)",
  "banner.editor.moveDown": "Move layer {n} up the stack (painted later)",
  "banner.editor.remove": "Delete layer {n}",
  "banner.editor.add": "+ Add pattern",
  "banner.editor.full": "A banner shows at most {max} layers.",
  "banner.editor.loom": "More than {max} layers cannot be made on a loom; the game still draws them.",
  "banner.editor.paste": "Paste a /give command or a pattern list",
  "banner.editor.apply": "Apply",
  "banner.editor.noPatterns": "That text carries no banner patterns.",
  ...
  "task.changingBannerPatterns": "Changing the banner patterns",
